...
void Image::ChangeLayout(const CommandBuffer& cmdBuffer, VkFormat format, VkImageLayout newLayout) {
   ...
   vkCmdPipelineBarrier(cmdBuffer.data(), sourceStage, destinationStage, 0,
                        0, nullptr,
                        0, nullptr,
                        1, &barrier
   );
...
Texture::~Texture() { if (Data) stbi_image_free(Data); }